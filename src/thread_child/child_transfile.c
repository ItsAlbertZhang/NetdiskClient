...
static size_t recv_splice_n(int connect_fd, int filefd, struct progress_bar_t progress_bar, int *pipefd);

int child_s2c(int connect_fd, int filefd, struct progress_bar_t progress_bar, int pipefd[2]) {
    int ret = 0;
